...
docker run -d --rm --gpus all --name temp -p 10022:22 -p 13389:3389 -v temp:/temp \
    registry.cn-hangzhou.aliyuncs.com/phzn/nvidia_cuda:11.8.0-cudnn8-devel-ubuntu18.04-v0.1