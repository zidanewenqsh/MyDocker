...
# docker run -it --rm --gpus all --name n22 -p 10022:22 -p 13389:3389 -v temp:/temp ubuntu:22.04-v0.2 bash
docker run -d --rm --gpus all --name n22 -p 10022:22 -p 13389:3389 -v temp:/temp ubuntu:22.04-v0.2
